...
class _booksyearoneState extends State<booksyearone>with SingleTickerProviderStateMixin{
  ...
  final hp = Screen(context).hp;
    ...
    data2.add(detail("Advanced Calculas", "https://images-eu.ssl-images-amazon.com/images/I/41JxHeBcBJL._SX342_SY445_QL70_ML2_.jpg",
        "https://drive.google.com/file/d/15TY56fVWZXyk3vYzcJNV_MWyr5EwOJq4/view?usp=sharing"));
    data2.add(detail("Aptitude", "https://1.bp.blogspot.com/-WXZQfSe4lLw/XTg0rDQMRWI/AAAAAAAACcA/nunjcYkdTDwd2PURITT-LT-3lAEd75rogCLcBGAs/s1600/quantitative%2Baptitude%2B%25281%2529.png",
        "https://drive.google.com/file/d/1ksEwvC8ejdveVN5ZVnmX2T2yiFyjMhAf/view?usp=sharing"));
    data2.add(detail("Programming For Problem Solving", "https://images-na.ssl-images-amazon.com/images/I/61Aa6VMDBhL.jpg",
    ...
    data2.add(detail("French", "https://ia800900.us.archive.org/BookReader/BookReaderImages.php?zip=/16/items/afrenchgrammarb00breygoog/afrenchgrammarb00breygoog_tif.zip&file=afrenchgrammarb00breygoog_tif/afrenchgrammarb00breygoog_0008.tif&id=afrenchgrammarb00breygoog&scale=8&rotate=0",
        "https://drive.google.com/file/d/1eKqSwGksILWFL-2RoYFyGNsIutvdrDjw/view?usp=sharing"));
    data2.add(detail("Chemistry", "https://chemistry.com.pk/wp-content/uploads/2014/08/Essential-Chemistry.jpg",
    ...
    data1.add(detail("Basic Electrical", "http://techbooksyard.com/doc-images/3635.png", "https://drive.google.com/file/d/1L0hOTTRr5w0C1-898tY2nsDhLd-Twfg5/view?usp=sharing"));
    data1.add(detail("Engineering Graphics", "https://engineeringbookspdf.com/doc-images/7381.png", "https://drive.google.com/file/d/1SRiJ9Job6JI3TQKvQam_f0mIDSCZomkd/view?usp=sharing"));
    data1.add(detail("English", "https://images-na.ssl-images-amazon.com/images/I/81N6Go0iECL.jpg", "https://drive.google.com/file/d/1SZB6QnVsQnntprjIS3CuYrM_pdkRIqcR/view?usp=sharing"));
    data1.add(detail("Linear Algebra", "https://m.media-amazon.com/images/I/31ymIAQWgjL.jpg", "https://drive.google.com/file/d/1k087YPgunT78SxXmRUu4Sx3h43drEG6B/view?usp=sharing"));
    data1.add(detail("SemiConductor Physics", "https://easyengineering.net/wp-content/uploads/2018/01/51ZRIOtS8JL.jpg", "https://drive.google.com/file/d/1b4SHi-2Che5HxsLv5anpZ6040JhdeBy8/view?usp=sharing"));
